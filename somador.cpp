...
int main() {
    ...
    cin >> n;
    cout << "Digite o número de partes: ";
    cin >> k;
    ...
    for (int i = 0; i < 10; i++) {
        ...
        // Imprime o resultado total
        cout << "Resultado total multi-threaded: " << resultadoTotal << endl;
        ...
        cout << "Resultado total single-threaded: " << resultado_single_thread << endl;
    }
